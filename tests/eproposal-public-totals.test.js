...
const internalTotalsEnd = documentRenderer.indexOf('`;', internalTotalsStart + 1);
assert(internalTotalsEnd > internalTotalsStart, 'internal totals branch must be locatable');
const internalTotalsBranch = documentRenderer.slice(internalTotalsStart, internalTotalsEnd);
