...
const Permissions = {
  ...
  tabPermissionRequirements: Object.freeze({
    ...
    communicationCentre: [{ resource: 'communication_centre', action: 'manage' }, { resource: 'communication_centre', action: 'view' }, { resource: 'communication_centre', action: 'list' }, { resource: 'communication_centre', action: 'get' }],
    communication_centre: [{ resource: 'communication_centre', action: 'manage' }, { resource: 'communication_centre', action: 'view' }, { resource: 'communication_centre', action: 'list' }, { resource: 'communication_centre', action: 'get' }],
