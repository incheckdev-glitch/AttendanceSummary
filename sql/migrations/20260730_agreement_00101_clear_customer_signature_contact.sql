...
with target as (
  ...
  select unnest(array[
    ...
    'customer_signature_date', 'customer_signed_by_name', 'customer_signed_by_email',
    'customer_signed_at', 'customer_accepted_at', 'customer_signature_type', 'customer_signature_text',
    'customer_signature_image_data_url', 'customer_signed_document_data_url',
    'e_signature_customer_name', 'e_signature_customer_email', 'e_signature_signed_at',
    'e_signature_type', 'e_signature_text', 'e_signature_image_data_url', 'e_signature_confirmed',
    'e_agreement_accepted_at', 'e_agreement_accepted_by_name', 'e_agreement_accepted_by_email',
    'e_agreement_signature_type', 'e_agreement_signature_text',
    ...
    'e_agreement_signature_customer_email', 'e_agreement_signature_confirmed'
  ]::text[])
), remaining as (
