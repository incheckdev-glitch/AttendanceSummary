(function initHRModule(global) {
  ...
  function isSalaryAdvanceReceipt(row) { return norm(row?.receipt_type || 'salary_payment') === 'salary_advance'; }
  function receiptTypeLabel(row) { return isSalaryAdvanceReceipt(row) ? 'Salary Advance' : 'Salary Payment'; }
