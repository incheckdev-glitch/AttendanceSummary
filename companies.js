...
const Companies = {
  ...
  renderCompanyVerificationBadge(company = {}) {
    const status = String(company?.documents_verification_status || company?.documentsVerificationStatus || (company?.documents_verified ? 'verified' : 'not_verified') || 'not_verified').trim().toLowerCase();
