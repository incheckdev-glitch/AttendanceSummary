...
function cacheEls() {
  [
    ...
    'newTicketPriority',
    'newTicketModule',
    'newTicketEmailAddressee',
    'newTicketCategory',
    'newTicketLink',
    'newTicketUploadDropzone',
    'newTicketUpload',
    'newTicketUploadName',
    'newTicketNameError',
    'newTicketDepartmentError',
    'newTicketTitleError',
    'newTicketDescriptionError',
    'newTicketPriorityError',
    'newTicketModuleError',
    'newTicketEmailAddresseeError',
    'newTicketCategoryError',
    'newTicketLinkError',
    'startDateFilter',
    'endDateFilter',
    'issuesTab',
